...
class Raca extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nome_raca', 'required'),
			array('nome_raca', 'length', 'max'=>128),
			array('conteudo', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_raca, nome_raca, conteudo', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'personagems' => array(self::HAS_MANY, 'Personagem', 'id_raca'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nome_raca',$this->nome_raca,true);
