...
/**
 * This is the model class for table "personagem_encontro".
 *
 * The followings are the available columns in table 'personagem_encontro':
 ...
 */
class PersonagemEncontro extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id_encontro, id_personagem', 'required'),
			array('id_encontro, id_personagem, hp, iniciativa', 'numerical', 'integerOnly'=>true),
			array('bonus', 'length', 'max'=>512),
			array('customizado', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_encontro, id_personagem, hp, bonus, customizado, iniciativa', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return PersonagemEncontro the static model class
	 */
